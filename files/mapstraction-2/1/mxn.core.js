 ...
 */
 var Mapstraction = mxn.Mapstraction = function(element, api, debug) {
	var api = api; // could detect this from imported scripts?
	this.maps = {};
	...
	// TODO: Events
	mxn.addEvents(this, ['load', 'markerAdded', 'markerRemoved', 'polylineAdded', 'polylineRemoved']);
...
Mapstraction.prototype.addImageOverlay = function(id, src, opacity, west, south, east, north) {
	...
	this.invoker.go('addImageOverlay', arguments, oContext);
};
